...
export default function Sidebar() {
  return (
    <div
      className="relative w-full h-auto lg:max-h-[85vh] lg:overflow-y-scroll flex  md:p-20 gap-16 pt-10 justify-center items-center  text-light font-bold tracking-wide flex-wrap  "
      style={{
        scrollbarWidth: "none",
      }}
    >
