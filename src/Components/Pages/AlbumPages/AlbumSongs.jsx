...
const AlbumSongs = ({ album }) => {
  ...
  let handleFavouriteSongs = async (song) => {
    ...
    isSongExists = profileData?.favouriteSongs?.some(
    ...
    <div className="w-full md:px-10 px-2 ">
      ...
      {allSongsData.map((song, index) => {
        return (
          <div
            key={index}
            className="w-full border-2 border-secondary h-[100px]   grid grid-cols-[40%_60%] md:grid-cols-4 mb-10 rounded-md  items-center md:px-10 hover:bg-secondary"
            style={
          ...
          >
            ...
            <div className="flex items-center pl-2  md:pl-0">
              ...
              <div
                ...
                onClick={() => handleAudioInAlbum(index)}
              >
                <img
            ...
            <div
              className="hidden  cursor-pointer text-xl md:flex justify-center"
              onClick={() => handleFavouriteSongs(song)}
            >
