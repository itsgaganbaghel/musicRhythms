...
const Menu = () => {
    ...
    return (
      ...
      >
        {authUserData?.photoURL ? (
          ...
          <span className="pb-3  rounded-2xl px-6 py-2 border-2 border-primary hover:bg-secondary  hover:shadow-[inset_5px_-5px_5px_#101215,inset_-5px_5px_5px_#424655] ">
            Profile
          </span>
        )}
      </div>
  ...
  return (
    <div className="flex items-center  text-xl gap-5 pr-2 text-light font-semibold">
      {authUserData ? isAuthenticatedUser() : isAnonymousUser()}
      {/* <button
